          ...
          <section class="col-md-6 offset-md-3">
            ...
            <div class="panel" style="border:solid 3px #0A4833;background-color: white;">
              ...
              <div class="panel-body p-3">
                <form method="post" action="{{ route('posts.update',$editdata->id) }}" enctype="multipart/form-data" id="quickForm" >
                  @csrf
                <div class="form-row">
                ...
                <font style="color:red">{{($errors)->has('category_id')?($errors->first('category_id')):''}}</font>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="post_title"class="form-control"  name="post_title" id="post_title" placeholder="Enter Post Title" value="{{ $editdata->post_title }}">
                ...
                <font style="color:red">{{($errors)->has('post_title')?($errors->first('post_title')):''}}</font>
                 ...
                 <div class="form-group col-md-12">
                    ...
                    <input type="short_title"class="form-control"  name="short_title" id="short_title" placeholder="Enter Short Title" value="{{ $editdata->short_title }}">
                ...
                <font style="color:red">{{($errors)->has('short_title')?($errors->first('short_title')):''}}</font>
                    ...
                    <textarea class="form-control" name="post_details" id="post_details" placeholder="Enter Post Details" rows="5">{{ $editdata->post_details }}
                    </textarea>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="date" class="form-control" name="post_date" id="post_date" placeholder="Enter Post Date" value="{{ $editdata->post_date }}">
                      <font style="color:red">{{($errors)->has('post_date')?($errors->first('post_date')):''}}</font>
                  </div>

                    <div class="form-group col-md-12"> 
                   <img id="showimage" src="{{(!empty($editdata->image))?url('upload/postimage/'.$editdata->image):url('upload/usernoimage.png')}}"
