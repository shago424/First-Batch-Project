          ...
          <section class="col-md-12 ">
            ...
            <div class="panel" style=" background: white">
              <div class="panel-header p-2" style="background-color: #0A4833;color: white">
                <h4>Student List
                <a href="{{ route('students.add') }}" class=" btn btn-warning float-right"><i class="fa fa-plus-circle"></i>
                  Add student
                </a>
               </h4>
              </div><!-- /.panel-header -->
            ...
            <table id="example1" class="table table-bordered table-hover table-sm">
                  ...
                  <tr>
                    ...
                    <td> 
                      ...
                      @endif
                        <a  href="{{ route('students.edit',$student->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
