          ...
          <section class="col-md-6 offset-md-3">
            ...
            <div class="panel" style="border:solid 3px #0A4833;background-color: white;">
              ...
              <div class="panel-body p-3">
                <form method="post" action="{{ route('principals.store') }}" enctype="multipart/form-data" id="quickForm" >
                  @csrf
                <div class="form-row">
                  
                  <div class="form-group col-md-12">
                    <label for="name">Name</label>
                    <input type="name"class="form-control"  name="name" id="name" placeholder="Enter Name" value="">
                <font style="color:red">{{($errors)->has('name')?($errors->first('name')):''}}</font>
                  </div>

                    <div class="form-group col-md-12">
                    <label for="degi">Designation</label>
                    <input type="text" class="form-control" name="degi" id="degi" placeholder="Enter Designation">
                  ...
                  <div class="form-group col-md-12">
                   ...
                   <div class="form-group col-md-12">
                    <input type="submit" name="submit" value="Add Principal" class="btn btn-success">
