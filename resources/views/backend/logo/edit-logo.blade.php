          ...
          <section class="col-md-6 offset-md-3">
            ...
            <div class="panel" style="border:solid 3px #0A4833;background-color: white;">
              <div class="panel-header p-2" style="border:solid 3px #0A4833;background-color: #0A4833;color: white">
                <h4>Edit Logo
                <a href="{{ route('logos.view') }}" class=" btn btn-warning float-right"><i class="fa fa-plus-circle"></i>
                 Logo List
                </a>
               </h4>
              </div><!-- /.panel-header -->
              <div class="panel-body p-3">
                <form method="post" action="{{ route('logos.update',$editdata->id) }}" enctype="multipart/form-data" id="quickForm" >
                  @csrf
                <div class="form-row">
                    ...
                    <img id="showimage" src="{{(!empty($editdata->image))?url('upload/logoimage/'.$editdata->image):url('upload/usernoimage.png')}}"
