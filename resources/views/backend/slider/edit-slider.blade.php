          ...
          <section class="col-md-6 offset-md-3">
            ...
            <div class="panel" style="border:solid 3px #0A4833;background-color: white;">
              <div class="panel-header p-2" style="border:solid 3px #0A4833;background-color: #0A4833;color: white">
                <h4>Edit Slider
                <a href="{{ route('sliders.view') }}" class=" btn btn-warning float-right"><i class="fa fa-plus-circle"></i>
                  Slider List
                </a>
               </h4>
              </div><!-- /.panel-header -->
              <div class="panel-body p-3">
                <form method="post" action="{{ route('sliders.update',$editdata->id) }}" enctype="multipart/form-data" id="quickForm" >
                  @csrf
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="description" id="description" placeholder="Enter description">{{ @$editdata->description }}</textarea>
                   ...
                   <div class="form-group col-md-12">
                    <input type="submit" name="submit" value="Update Slider" class="btn btn-danger">
