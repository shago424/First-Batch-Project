...
<div class="row mt-3 mb-5">
	...
	<div class="panel-header text-white" >
		...
		<h4 style="margin-top:-75px" class=" p-3">All Recent Post  <button class="float-right btn btn-warning">
			</button>
		</h4>
	</div>
				...
				<table class="table  table-hover table-bordered table-sm" width="100">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn btn-success btn-sm" href="{{ route('post.details',$post->id) }}"><i class="fa fa-eye"></i> Post View</a></td>
						</tr>
						@endforeach
